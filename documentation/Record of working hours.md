...
| 20.12 | 10         | Changed how the overview page looks i nteh GUI, and refactored previously written code. Added ability for GUI to show messages (e.g. in case of errors), and update the main page of the GUI as categories and runs are added/deleted. Updating the reqirements specification and architecture description in the remote depository. Made new sequence diagrams for creating a new category and run. Made testing document, updated other project documentation, and made final release.
| Tot.  | 102        |
