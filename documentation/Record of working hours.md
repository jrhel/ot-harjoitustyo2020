...
| 20.12 | 4         | Changed how the overview page looks i nteh GUI. Added ability for GUI to show messages (e.g. in case of errors), and update the main page of the GUI as categories and runs are added/deleted.
| Tot.  | 90        |
